...
function uiSwipe(swipeActions){
    ...
    this.blnMouse = (typeof swipeActions.mouseSwipe  === "boolean" || typeof swipeActions.mouseSwipe  === "number")? swipeActions.mouseSwipe : false ;
    
    $("#tester1").html( "all: "+ this.blnA +" - type: " + (typeof swipeActions.swipeAll) +" - alt:"+ (typeof swipeActions['swipeAll']));
    
    if (typeof swipeActions.minDistance    === "number"){
        if (swipeActions.minDistance > 1 ) {
            this.minSwipeDist = swipeActions.minDistance;
        } else if (swipeActions.minDistance < 1 && swipeActions.minDistance > 0 ) {
            this.minSwipeDist = document.documentElement.clientWidth * swipeActions.minDistance;
        }
    }
    ...
    this.final = function(){
        ...
        $("#tester1").html(this.distance.toFixed(2) +" > "+ this.minSwipeDist.toFixed(2));
